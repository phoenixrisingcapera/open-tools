---
description: Organize a tangled thought into saved actionable items by asking one important question at a time and persisting each idea safely.
agent: adhd-finisher
---

Load the `adhd-workflow` skill and use a bounded thinking-organization workflow for this topic:
...
1. Save the thinking safely.
2. Reduce overwhelm.
3. Ask the single next question that most helps complete the thought.
4. Keep the active path narrow and concrete.
